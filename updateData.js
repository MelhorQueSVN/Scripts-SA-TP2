        ...
        .then(
            axios.spread((...responses) => {
                ...
                tf.loadLayersModel('http://localhost:8080/keras_model/model.json')
                    .then((model) => {
                        var braga_tensor = tf.tensor3d([
                            [results_braga]
                        ]);
                        var porto_tensor = tf.tensor3d([
                            [results_porto]
                        ]);
                        var lisboa_tensor = tf.tensor3d([
                            [results_lisboa]
                        ]);
                        var aveiro_tensor = tf.tensor3d([
                            [results_aveiro]
                        ]);
                        var beja_tensor = tf.tensor3d([
                            [results_beja]
                        ]);
                        var braganca_tensor = tf.tensor3d([
                            [results_braganca]
                        ]);
                        var castelobranco_tensor = tf.tensor3d([
                            [results_castelobranco]
                        ]);
                        var coimbra_tensor = tf.tensor3d([
                            [results_coimbra]
                        ]);
                        var evora_tensor = tf.tensor3d([
                            [results_evora]
                        ]);
                        var faro_tensor = tf.tensor3d([
                            [results_faro]
                        ]);
                        var guarda_tensor = tf.tensor3d([
                            [results_guarda]
                        ]);
                        var leiria_tensor = tf.tensor3d([
                            [results_leiria]
                        ]);
                        var portalegre_tensor = tf.tensor3d([
                            [results_portalegre]
                        ]);
                        var santarem_tensor = tf.tensor3d([
                            [results_santarem]
                        ]);
                        var setubal_tensor = tf.tensor3d([
                            [results_setubal]
                        ]);
                        var vianadocastelo_tensor = tf.tensor3d([
                            [results_vianacastelo]
                        ]);
                        var vilareal_tensor = tf.tensor3d([
                            [results_vilareal]
                        ]);
                        var viseu_tensor = tf.tensor3d([
                            [results_viseu]
                        ]);
